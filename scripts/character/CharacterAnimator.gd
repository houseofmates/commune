...
func _create_animations() -> void:
	...
	idle_anim.track_insert_key(track, 0.0, {"method": "set_bob", "args": [0.0]})
	idle_anim.track_insert_key(track, 1.0, {"method": "set_bob", "args": [-2.0]})
	idle_anim.track_insert_key(track, 2.0, {"method": "set_bob", "args": [0.0]})
	...
	walk_anim.track_insert_key(track, 0.0, {"method": "set_bob", "args": [0.0]})
	walk_anim.track_insert_key(track, 0.25, {"method": "set_bob", "args": [-5.0]})
	walk_anim.track_insert_key(track, 0.5, {"method": "set_bob", "args": [0.0]})
	walk_anim.track_insert_key(track, 0.75, {"method": "set_bob", "args": [-5.0]})
